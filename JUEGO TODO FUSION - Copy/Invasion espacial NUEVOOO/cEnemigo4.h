#ifndef CENEMIGO4_H_INCLUDED
#define CENEMIGO4_H_INCLUDED
...
class Enemigo4 : public Entidad{
    ...
    public:
            TiroEn tiroEnemigo;
            Enemigo4(){
            imagen = al_load_bitmap("imagenes/enemigo6.png");
